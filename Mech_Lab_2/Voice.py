...
# Raspberry Pi specific imports - commented out for Linux laptop testing
# import board
# import displayio
# import fourwire
...
# Raspberry Pi DotStar LED initialization - commented out for Linux laptop testing
...
def display_picture(category):
    ...
    # Raspberry Pi display - commented out for Linux laptop testing
    # load_image(path + "/" + get_random_file(path))
    # Linux laptop alternative - just print the filename
    filename = get_random_file(path)
    if filename:
        print("Would display image: {}/{}".format(path, filename))
    else:
        print("No image found in category: {}".format(category))
...
# Raspberry Pi display function - commented out for Linux laptop testing
# def load_image(path):
...
def change_light_color(lightname, color):
    # Raspberry Pi DotStar LED control - commented out for Linux laptop testing
    # dotstar_number = lights.index(lightname)
    # dots[dotstar_number] = colors[color]
    # Linux laptop alternative - just print the action
    print("Would set {} light to {} (0x{:06X})".format(lightname, color, colors[color]))
...
# Raspberry Pi display initialization - commented out for Linux laptop testing
...
print("Voice assistant ready - Linux laptop mode (no GPIO/display hardware)")
